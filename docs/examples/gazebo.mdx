...
The Gazebo simulator is a sophisticated, industry standard, simulator for robots. The robot shape/size is specified via `.dae` files and those robots can then navigate a defined digital world. The simulation framework is useful for prototyping, debugging, and reinforcement learning, among many other uses. 
...
Refer to the [Installation Guide](/getting-started/get-started) for detailed instructions.
