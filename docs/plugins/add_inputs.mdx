...
<CardGroup cols={1}>
  <Card 
    ...
    icon="microphone"
    href="https://github.com/OpenmindAGI/OM1/blob/main/src/inputs/plugins/asr.py">
  ...
  <Card 
    ...
    icon="camera"
    href="https://github.com/OpenmindAGI/OM1/blob/main/src/inputs/plugins/vlm_cloud.py">
